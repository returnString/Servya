...
namespace HelloWorld
{
	...
	class ProgramService
	{
		...
		// Available as: http://host/program/belatedhello?name=whatever
		// The response will take ~2s to come through, but this won't block server resources
		[Route]
		public async Task<string> BelatedHello(string name)
		{
